          ...
          <form>
            ...
            <div className='flex w-full gap-8'>
              <div className='w-full border border-black rounded-md dark:border-slate-400 duration-700 ease-linear'>
                <input type="number" name='age' id='age' placeholder='Enter Age' className='border-none w-full rounded-md dark:bg-transparent duration-700 ease-linear focus:ring-0'/>
              </div>
              <div className='w-full rounded-md border border-black dark:border-slate-400 duration-700 ease-linear'>
                <input type="number" name='grade' id='grade' placeholder='Enter Grade' className='border-none w-full rounded-md dark:bg-transparent duration-700 ease-linear focus:ring-0'/>
              </div>
            </div>
            <div className='flex flex-col md:flex-row w-full gap-8 py-10'>
              <div className='w-full rounded-md'>
                <input type="text" name="GuardianName" id="GuardianName" placeholder='Guardian or Parent Name' className='w-full rounded-md dark:bg-transparent dark:border-slate-400 duration-700 ease-linear focus:ring-0 text-center'/>
              </div>
              <div className='w-full rounded-md'>
                <input type="tel" name="GuardianContact" id="GuardianContact" placeholder='Parent or Guardian Contact' className='w-full rounded-md dark:bg-transparent dark:border-slate-400 duration-700 ease-linear focus:ring-0 text-center'/>
              </div>
            </div>
            <div className='flex flex-col md:flex-row w-full gap-8'>
              <div className='w-full border-black border dark:border-slate-400 rounded-md'>
                <input type="text" name="Location" id="Location" placeholder='Your Location' className='dark:bg-transparent duration-700 ease-linear border-none w-full rounded-md text-center focus:ring-0'/>
              </div> 
              <div className='border border-black dark:border-slate-400 rounded-md w-full text-center'>
                <select name="subject" id="subject" className='dark:bg-transparent duration-700 ease-linear border-none w-full rounded-md text-center focus:ring-0'>
                  <option value="dubjectSelection" className='dark:text-black duration-700 ease-linear'>Select Your Subject</option>
